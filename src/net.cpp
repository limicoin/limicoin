...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LimiCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
unsigned int pnSeed[] =
{
    0xA2FB5432, 0xdf4bd379, 0x7934d29b, 0x26bc02ad, 0x7ab743ad, 
    ...
    0x702b135e, 0x0f57245e, 0xdaab5f5f, 0xba15ef63, 0x0ab3a7bc,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LimiCoin is probably already running."), addrBind.ToString().c_str());
        else
